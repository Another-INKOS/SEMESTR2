...
public:
    ...
    // Конструктор с параметрами (с пасхалкой)
...
int main() {
    ...
    do {
        ...
        cout << "4. 🎵 Пасхалка: Третье сентября 🎵\n";
        cout << "0. Выход\n";
        cout << "=================================================\n";
        ...
        // ----------------------------------------------------------
            ...
            bool isLeap = InputBool("Год високосный?");
            int workDays = InputInt("Введите количество рабочих дней в неделе (1-7): ");
            
            // Проверка: рабочие дни должны быть от 1 до 7
        ...
        // ----------------------------------------------------------
        // Пункт 4: пасхалка (отдельная демонстрация)
        // ----------------------------------------------------------
        else if (choice == 4) {
            cout << "\n🎶🎶🎶 ТРЕТЬЕ СЕНТЯБРЯ 🎶🎶🎶\n";
            cout << "Я календарь переверну — и снова третье сентября.\n";
            cout << "День, когда Шуфутинский поёт в каждом сердце.\n";
            cout << "\nСоздайте праздничный календарь с названием:\n";
            cout << "  - '3 сентября'\n";
            cout << "  - 'Сентябрь'\n";
            cout << "  - или с тремя праздниками\n";
            cout << "и пасхалка появится автоматически!\n";
        }

    } while (choice != 0);

    cout << "\nПрограмма завершена. Спасибо за использование календарей!\n";
    return 0;
}    T year;        // год (тип параметризован шаблоном)
    int daysInYear;// количество дней в году (только 365 или 366)
